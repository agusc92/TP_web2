    ...
    <div class="col-6">
      <form method="post" action="{$URL_BASE}/edit_confirm">
        <div class="mb-3">
          ...
          <input type="text" value="{$movie->movie_name}" class="form-control" id="name" name="movie_name" placeholder="las aventuras de web 2">
        </div >
        <div class="mb-3">
          <label for="image" class="form-label">Imagen</label>
          <input type="text" value="{$movie->movie_image}" class="form-control" id="image" name="image" placeholder="Inserte link hacia una imagen">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="number" value="{$movie->movie_date}" class="form-control" id="date" name="date" placeholder="1995">
        </div>
        <div class="mb-3">
          <label for="synopsis" class="form-label">Sinopsis</label>
          <textarea class="form-control"  id="synopsis" name="synopsis" placeholder="Una breve sinopsis de la pelicula">{$movie->synopsis}</textarea>
        </div>
